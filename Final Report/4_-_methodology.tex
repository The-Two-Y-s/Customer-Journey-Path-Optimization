...
def dijkstra_pruned(graph: Graph, start: str, goal: str,
                    tau: float = 0.01) -> DijkstraResult:
    pq = [(0, start)]
    dist = {start: 0}
    parent = {}
