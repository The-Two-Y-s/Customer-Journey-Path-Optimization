...
% ---- AIT: Times New Roman ----
\usepackage{mathptmx}
\usepackage{courier}          % Courier monospace (standard TNR companion)
...
% Global line-break flexibility to minimize non-critical overfull boxes.
...
\begin{document}
    ...
    \input{2_-_introduction}
    \input{3_-_literature_review}
    \input{4_-_methodology}
    \input{4b_-_correctness}
    \input{4c_-_complexity}
    \input{5_-_results}
    \input{6_-_conclusion}
    \input{7_-_project_plan}
