...
Finally, the reachability--speed trade-off was characterised in detail. Increasing $\tau$ yields faster search but reduces path-found rates, from 28.6\% at $\tau=0.001$ to 3.9\% at $\tau=0.5$ on synthetic data. This trade-off is inherent and well understood. Real-world graphs exhibited additional reachability limitations due to natural session fragmentation.
