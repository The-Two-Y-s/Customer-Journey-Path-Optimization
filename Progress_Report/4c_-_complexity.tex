...
\bottomrule
\end{tabular}
\caption[Complexity summary]{Complexity summary. Pruning reduces empirically observed time without affecting worst-case or space bounds. The empirical bound $O(|E'|\log|V|)$ is consistently confirmed by experiment (Section~\ref{sec:empirical_time}) but depends on the input distribution.}
